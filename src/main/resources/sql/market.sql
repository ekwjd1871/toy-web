...
INSERT INTO `item` VALUES (3, '[크리넥스] 도톰한 천연펄프 3겹 카카오 화장지 30m', '식품/생필품', '13000', '12700', '무료', '100', 'tissue.jpg', 'tissue_de.png');
INSERT INTO `item` VALUES (4, '[일리]프란시스 Y3.2 커피머신(화이트, 레드, 블랙, 블루)', '가전/컴퓨터/디지털', '174000', '165900', '2,500원', '100', 'coffee.jpg', 'coffee_de.jpg');
INSERT INTO `item` VALUES (5, '[시디즈]T500HLDA 에어 화이트쉘 메쉬의자', '가전/컴퓨터/디지털', '98000', '85600', '무료', '100', 'chair.jpg', 'chair_de.jpg');
...
CREATE TABLE `orders`  (
  ...
  `is_delivery` tinyint(2) NOT NULL,
...
INSERT INTO `orders` VALUES (17, 'test', 2, '1', '0', 0, '2020-05-30\n18:30');
INSERT INTO `orders` VALUES (18, 'test', 1, '8', '0', 0, '2020-05-30\n19:03');
...
-- Records of users
-- ----------------------------
INSERT INTO `users` VALUES ('id', 'pw', 'name', 'TESTER');
INSERT INTO `users` VALUES ('test', '123', '우동', 'USER');
